  ...
  return (
    <div className="container py-5">
      ...
      <section className="instructions card mt-5">
        ...
        <ul>
          <li>Click <strong>Log In</strong> to access personalized features.</li>
          <li>Upload your resume using the button above, or start from scratch.</li>
      ...
      {/* Extra Section: Contact or Footer */}
      <footer className="footer mt-5 text-center">
        <hr />
        <p>
          &copy; {new Date().getFullYear()} Rezoom &mdash; Crafted with <span style={{color: '#b39ddb'}}>deep purple</span> passion.<br />
          Need help? <a href="mailto:support@rezoom.ai" style={{color: '#b39ddb'}}>Contact Support</a>
        </p>
      </footer>
